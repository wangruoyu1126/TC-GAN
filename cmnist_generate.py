...
from models.cmnist_model import Generator
...
print(generated_img1.shape, generated_img2.shape)
from torchvision.utils import save_image
save_image(generated_img1, "generated_img1.png", nrow=10, normalize=True)
save_image(generated_img2, "generated_img2.png", nrow=10, normalize=True)
save_image(generated_img3, "generated_img3.png", nrow=10, normalize=True)
